    ...
    <div style={styles.card}>
      ...
      {!reviewed && (
        <div style={styles.cardActions}>
          <button style={styles.approveBtn} onClick={onApprove} disabled={approving}>
            {approving ? "Approving..." : "✓ Approve"}
          </button>
          <button style={styles.rejectBtn} onClick={onReject} disabled={rejecting}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  cardDetails: { display: "flex", flexDirection: "column", gap: 4, marginBottom: 12 },
